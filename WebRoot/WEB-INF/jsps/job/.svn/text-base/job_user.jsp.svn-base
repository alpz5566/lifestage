		...
		<div class="fctxtLeft" id="trainUserLeft">
				...
				<div class="fczuLeftMain trainUserMain">
					...
					<div class="fczuLMform">
						<span class="fczuLMfour fczuLMstar">招聘名称</span><input class="fczuLMinput trainUserMinputname yhinput" id="fczuinput" type="text" value="请填写招聘职位名称"></input>
					</div>
					<div class="fczuLMform">
						<span class="fczuLMfour fczuLMstar">公司名称</span><input class="fczuLMinput trainUserMinputname yhinput" id="fczuinput" type="text" value="请填写招聘职位名称"></input>
					</div>
					<div class="fczuLMform">
						<span class="fczuLMfour fczuLMstar">公司规模</span>
					...
					<div class="fczuLMform">
						<span class="fczuLMfour">公司网址</span><input class="fczuLMinput fczuLMinputcaradd" id="fczuinput" type="text"></input>
					</div>					
					<div class="fczuLMform mapC">
						<span class="fczuLMfour mapAdd">地理位置</span>
						<div id="container"></div>
						<div id="map_container" class="mapContainer" style=""></div>	
					...
					<div class="fczuLMform trainScooltxt">
						<span class="fczuLMtext trainScoolText">公司介绍</span>
