	...
	<div class="fctxtContent" id="fczuContent">
		<div class="fctxtLeft" id="fczuLeft">
				...
				<div class="fczuLeftMain">
					<form action="${pageContext.request.contextPath}/apartment/save" method="post" enctype="multipart/form-data">
					...
					<div class="fczuLMform">
						<span class="fczuLMtwo fczuLMstar">标题</span><input class="fczuLMinput fczuLMinputbiaoti" name="" id="fczuinput" type="text"></input>
					</div>
					<div class="fczuLMform">
						<span class="fczuLMfour fczuLMstar">小区名称</span><input class="fczuLMinput fczuLMinputname" name="plotName" id="fczuinput" type="text"></input>
					</div>
					<div class="fczuLMform">
					...
					<div class="fczuLMform">
						<span class="fczuLMtwo fczuLMstar">租金</span>
						<input type="text" class="fczuLMinput fczuLMinputzujin" name="monny" id="zujin"/><label for="zujin">/月</label>
					</div>
					<div class="fczuLMform">
						<div class="fczuLMleixing">
							<span class="fczuLMtwo fczuLMstar">租金方式</span>
							<select class="fczuLMsort" name="monny_typeBean.id">
								<option value="0">--请选择--</option>
								<c:forEach items="${monnyList}" var="ml">
					...
					<div class="fczuLMform ">
						...
						<input type="text" class="fczuLMinput fczuLMinputzu" name="room" id="shi"/><label for="shi">室</label>
						<input type="text" class="fczuLMinput fczuLMinputzu" name="liveroom" id="ting"/><label for="ting">厅</label>
						<input type="text" class="fczuLMinput fczuLMinputzu" name="bathroom" id="wei"/><label for="wei">卫</label>
					</div>
					<div class="fczuLMform">
						<span class="fczuLMfour fczuLMstar">房屋面积</span>
						<input type="text" class="fczuLMinput fczuLMinputzu" name="area" id="m"/><label for="m">/m2</label>
					</div>
					<div class="fczuLMform">
						<div class="fczuLMleixing">
							<span class="fczuLMtwo fczuLMstar">类型</span>
							<select class="fczuLMsort" name="house_typeBean.id">
								<option value="0">--请选择--</option>
							...
							<span id="fczuLMzx ">装修情况</span>
							<select class="fczuLMsort" name="situationBean.id">
								<option value="0">--请选择--</option>
								<c:forEach items="${situationList}" var="sl">
					...
					<div class="fczuLMform">
						...
						<input type="text" class="fczuLMinput fczuLMinputzu" name="floor" id="louc"/><label for="louc">层</label>
						<label for="louc">共</label><input type="text" class="fczuLMinput fczuLMinputzu" name="sumfloor" id="louc1"/><label for="louc">层</label>
					</div>
					<div class="fczuLMform fczuLMformtxt">
						<span class="fczuLMtext">房屋描述</span>
						<textarea class="gangwei" name="describe" ></textarea>
					</div>
					<div class="fczuLMform">
					...
					<div class="fczuLMform mapC">
						<span class="fczuLMfour mapAdd" >地图标注</span>
					...
					<div class="fczuLMform">
						...
						<%--<div class="fczuLMformfile">
							<input type="text" name="imgUrl" id="textfile" class="picMinput yhinput"/>
							<input id="txfile" class="pictxfile" type="file" name="txfile" onchange="document.getElementById('textfile').value=this.value"/>
						</div>
					--%></div>
					<div class="fczuLMimg">
